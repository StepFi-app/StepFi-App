...
const MOCK_NOTIFICATIONS: Notification[] = [
  ...
  },
  {
    ...
    body: 'TechStore has joined StepFi. Shop with BNPL now.',
                ...
                return (
                  <View
                    ...
                    <View className="flex-1 px-3">
                      <Text className="text-textStrong text-[15px] font-bold">{item.title}</Text>
                      <Text className="mt-0.5 text-[13px] leading-4 text-textSecondary">
                        {item.body}
                      </Text>
                      <Text className="text-textSubtle mt-1.5 text-[12px]">{item.timestamp}</Text>
                    </View>
