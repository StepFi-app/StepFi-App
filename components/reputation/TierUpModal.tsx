    ...
    <Modal transparent visible={isVisible} animationType="none" onRequestClose={onClose}>
      <View
        ...
        <Animated.View
          ...
          <View
            className="mb-6 h-24 w-24 items-center justify-center rounded-full shadow-lg"
            style={{
          ...
          <Text className="mb-8 text-center text-lg" style={{ color: colors.textSecondary }}>
            You&apos;ve reached the{' '}
            <Text style={{ color: tierColor, fontWeight: 'bold' }}>{tier}</Text> tier.
          </Text>

          <View
            className="mb-10 w-full gap-4 rounded-2xl bg-subtle/50 p-4"
            style={{ backgroundColor: colors.subtle + '30' }}>
          ...
          <Button label="Awesome!" onPress={onClose} variant="primary" className="h-14 w-full" />
        </Animated.View>
      </View>
    </Modal>
  );
