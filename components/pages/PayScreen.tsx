...
const PayScreen = () => {
  ...
  const isProcessing =
    status === TransactionStatus.SIGNING || status === TransactionStatus.BROADCASTING;
    ...
    <View className="px-6 pt-6">
      ...
      <View className="mb-4 rounded-2xl bg-white p-6 shadow-sm">
        <View className="mb-4 flex-row items-center justify-between">
          <View className="flex-row items-center gap-2">
            <View className="bg-successBadge h-6 w-6 items-center justify-center rounded-full">
          ...
          <View className="bg-successSoft rounded-full px-3 py-1">
            <Text className="text-successDeep text-xs font-semibold">Verified</Text>
          </View>
        </View>
      ...
      <View className="mb-4 rounded-2xl bg-white p-6 shadow-sm">
        <View className="flex-row items-center justify-between">
          ...
          <View className="bg-amberSoft h-12 w-12 items-center justify-center rounded-xl">
      ...
      <View className="mb-4 rounded-2xl bg-white p-6 shadow-sm">
        <View className="mb-3 flex-row items-center gap-2">
          <View className="bg-successSoft rounded-full px-3 py-1">
            <Text className="text-successDeep text-xs font-semibold">ACTIVE</Text>
          </View>
        ...
        <Text className="text-text mb-1 text-4xl font-bold">$50.00</Text>
          ...
          <View className="mb-3 rounded-xl bg-red-50 p-3">
            <View className="flex-row items-start gap-2">
              ...
              <View className="flex-1">
                <Text className="text-sm font-semibold text-red-700">Payment failed</Text>
        ...
        {status === TransactionStatus.SUCCESS && txHash && (
          <View className="mb-3 rounded-xl bg-green-50 p-3">
            <View className="flex-row items-start gap-2">
              ...
              <View className="flex-1">
                <Text className="text-sm font-semibold text-green-700">Payment successful</Text>
      ...
      <View className="mb-4 flex-row gap-3">
        <TouchableOpacity
          ...
          <View className="bg-successSoft mb-3 h-12 w-12 items-center justify-center rounded-xl">
            <Ionicons name="eye-outline" size={24} color={colors.successDeep} />
          </View>
          <Text className="text-text text-center text-sm font-medium">View</Text>
          <Text className="text-text text-center text-sm font-medium">Reputation</Text>
        </TouchableOpacity>

        <TouchableOpacity
          activeOpacity={0.8}
          className="flex-1 items-center rounded-2xl bg-white p-5 shadow-sm">
          <View className="bg-amberSoft mb-3 h-12 w-12 items-center justify-center rounded-xl">
            <Ionicons name="compass-outline" size={24} color={colors.amber} />
          </View>
          <Text className="text-text text-center text-sm font-medium">Explore</Text>
          <Text className="text-text text-center text-sm font-medium">Merchants</Text>
        </TouchableOpacity>

        <TouchableOpacity
          activeOpacity={0.8}
          className="flex-1 items-center rounded-2xl bg-white p-5 shadow-sm">
          <View className="bg-errorSoft mb-3 h-12 w-12 items-center justify-center rounded-xl">
            <Ionicons name="time-outline" size={24} color={colors.error} />
          </View>
          <Text className="text-text text-center text-sm font-medium">Loan History</Text>
        </TouchableOpacity>
      </View>
      ...
      <View className="mb-6 rounded-2xl bg-white p-5 shadow-sm">
        <View className="flex-row items-center gap-3">
          ...
          <View className="flex-1">
            <Text className="text-text mb-1 font-semibold">You are eligible for BNPL</Text>
